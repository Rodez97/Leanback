...
using Loader = AndroidX.Loader.Content.Loader;
using Android.Graphics;

namespace TvLeanback
{
	public class MainFragment : BrowseSupportFragment, LoaderManager.ILoaderCallbacks, View.IOnClickListener, IOnItemViewSelectedListener//<Dictionary<string, IList<Movie>>>
	{
        ...
        public void OnLoadFinished(Loader p0, Object p1)
        {
            throw new System.NotImplementedException();
        }

        public void OnLoadFinished(Loader p0, Java.Lang.Object p1)
        {
